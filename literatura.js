/* Missão PMMG — Literatura • vídeos completos + prova final reforçada */
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "Miguilim é o centro da narrativa.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "A família vive no Mutúm, em Minas Gerais.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Um juiz.",
          "Um soldado.",
          "Um narrador-personagem adulto."
        ],
        "answer": 0,
        "explanation": "A focalização acompanha a percepção de Miguilim.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "João Guimarães Rosa é o autor.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "A experiência infantil e o amadurecimento estruturam a obra.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Ao litoral europeu.",
          "À metrópole industrial.",
          "A uma ilha fictícia."
        ],
        "answer": 0,
        "explanation": "O sertão mineiro e a natureza são fundamentais.",
        "tip": "Espaço também produz sentido."
      }
    ]
  },
  "2": {
    ...
    "quiz": [
      {
        ...
        "options": [
          "Irmão de Miguilim.",
          "Pai de Miguilim.",
          "Professor de Miguilim.",
          "Narrador da obra."
        ],
        "answer": 0,
        "explanation": "Dito é irmão de Miguilim e figura afetiva central.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Sem qualquer tensão.",
          "Uma família urbana rica.",
          "Um grupo de militares."
        ],
        "answer": 0,
        "explanation": "A narrativa mostra relações familiares complexas.",
      ...
      },
      {
        ...
        "options": [
          ...
          "À perda da fala.",
          "À mudança para o exterior.",
          "Ao abandono da família."
        ],
        "answer": 0,
        "explanation": "Os óculos revelam uma nova nitidez visual.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "A dureza paterna participa das tensões familiares.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Transformar a obra em comédia.",
          "Eliminar os conflitos."
        ],
        "answer": 0,
        "explanation": "Dito é decisivo no universo afetivo do protagonista.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Apenas por estudo escolar.",
          "Por uma viagem à Europa."
        ],
        "answer": 0,
        "explanation": "As experiências vividas transformam sua percepção.",
        "tip": "Formação = experiência."
      }
    ]
  },
  "3": {
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "A elaboração linguística é característica marcante de Rosa.",
      ...
      },
      {
        ...
        "options": [
          ...
          "É irrelevante.",
          "Aparece apenas no título.",
          "É sempre cenário urbano."
        ],
        "answer": 0,
        "explanation": "O ambiente natural participa da construção de sentidos.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Eliminar conflitos.",
          "Transformar o texto em documento jurídico.",
          "Criar narrador em primeira pessoa obrigatoriamente."
        ],
        "answer": 0,
        "explanation": "A focalização aproxima o leitor da experiência de Miguilim.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Perdas e descobertas participam da formação de Miguilim.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "A prova cobra conhecimento e interpretação da obra.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Mudança do narrador para primeira pessoa."
        ],
        "answer": 0,
        "explanation": "A nitidez visual reforça o movimento de descoberta.",
        "tip": "Símbolos dialogam com fatos concretos."
      }
    ]
  },
  "4": {
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Miguilim e Dito.",
          "Bentinho e Capitu.",
          "Macabéa e Olímpico apenas."
        ],
        "answer": 0,
        "explanation": "Essas são as figuras centrais da família retirante.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "A obra acompanha retirantes no sertão nordestino.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Baleia em primeira pessoa.",
          "Um narrador documental sem acesso interior."
        ],
        "answer": 0,
        "explanation": "A terceira pessoa aproxima o leitor dos pensamentos das personagens.",
      ...
      },
      {
        ...
        "options": [
          ...
          "É apenas metáfora sem efeito concreto."
        ],
        "answer": 0,
        "explanation": "A obra articula natureza e estruturas de opressão.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Um diário em primeira pessoa.",
          "Uma peça teatral."
        ],
        "answer": 0,
        "explanation": "O ciclo da retirada é estruturalmente importante.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Graciliano Ramos escreveu Vidas Secas.",
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "A cama simboliza conforto e estabilidade desejados.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Baleia é a cachorra da família e personagem marcante.",
      ...
      },
      {
        ...
        "options": [
          ...
          "À profissão de escritor.",
          "A um jogo cômico sem consequência."
        ],
        "answer": 0,
        "explanation": "A limitação verbal tem dimensão social.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "O narrador atribui interioridade e sensibilidade a Baleia.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Ser a antagonista principal.",
          "Viver fora do sertão."
        ],
        "answer": 0,
        "explanation": "Ela projeta uma vida mais digna para a família.",
      ...
      },
      {
        ...
        "options": [
          ...
          "É inexistente.",
          "É somente familiar.",
          "É exclusivamente religiosa."
        ],
        "answer": 0,
        "explanation": "Exploração e abuso institucional aparecem na obra.",
  ...
  "6": {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Baleia é a cachorra da família de Fabiano.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "É o espaço central da família de Miguilim.",
        "tip": "Mutúm → Minas."
      },
      {
        ...
        "answer": 0,
        "explanation": "A estrutura cíclica reforça a condição dos retirantes.",
      ...
      },
      {
        ...
        "options": [
          "Campo Geral.",
          "Vidas Secas.",
          "Ambas exatamente do mesmo modo.",
          "Nenhuma."
        ],
        "answer": 0,
        "explanation": "Miguilim descobre a miopia.",
        "tip": "Óculos → Miguilim."
      },
      {
        ...
        "answer": 0,
        "explanation": "É sonho de Sinhá Vitória em Vidas Secas.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Vidas Secas é centrada na percepção infantil de Miguilim.",
          "Campo Geral elimina conflitos familiares e sociais para privilegiar apenas descrição da natureza."
        ],
        "answer": 0,
        "explanation": "Há aproximações temáticas, mas diferenças decisivas de focalização, linguagem e composição.",
      ...
      },
      {
        ...
        "options": [
          ...
          "eliminam a importância do espaço sertanejo.",
          "representam exclusivamente riqueza material já alcançada."
        ],
        "answer": 0,
        "explanation": "Os símbolos articulam desejo, percepção e possibilidade de mudança, embora em contextos distintos.",
        "tip": "Símbolo deve ser interpretado dentro do percurso de cada personagem."
      }
    ]
  },
  "7": {
