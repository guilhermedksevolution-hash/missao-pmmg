/* Missão PMMG — Inglês • vídeos completos + questões reforçadas */
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "Captar a ideia geral.",
        "tip": "Use o contexto."
      },
      {
        ...
        "answer": 0,
        "explanation": "Localizar informação específica.",
        "tip": "Use o contexto."
      },
      {
        ...
        "options": [
          ...
          "Ignorar título.",
          "Traduzir tudo primeiro."
        ],
        "answer": 0,
        "explanation": "Usar contexto e palavras-chave.",
        "tip": "Use o contexto."
      }
    ]
  },
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Na opinião pessoal.",
          "Na alternativa maior.",
          "Em tradução total."
        ],
        "answer": 0,
        "explanation": "No texto e em suas pistas.",
        "tip": "Use o contexto."
      },
      {
        ...
        "answer": 0,
        "explanation": "Possibilidade/capacidade.",
        "tip": "Use o contexto."
      },
      {
  ...
  "9": {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Movimento para dentro.",
        "tip": "Revise a teoria escrita."
      },
      {
        "question": "Considere: I. at 8 p.m.; II. on Monday; III. in July. Quanto ao uso das preposições de tempo, assinale a opção correta.",
        "options": [
        ...
        "answer": 0,
        "explanation": "At é comum com horários; on com dias; in com meses.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Into indica movimento para dentro; from indica origem.",
        "tip": "Observe movimento e ponto de partida."
      },
      {
        "question": "Assinale a alternativa em que a preposição faz parte de uma combinação lexical adequada.",
        "options": [
          "responsible for the report.",
          "responsible at the report.",
          "afraid in dogs.",
          "depend at the result."
        ],
        "answer": 0,
        "explanation": "Responsible for é combinação consagrada.",
        "tip": "Preposições também fazem parte de collocations."
      }
    ]
  },
  "10": {
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "To be + particípio passado.",
        "tip": "Revise a teoria escrita."
      },
      {
      ...
      {
        "question": "Assinale a reescrita correta de “The officers arrested the suspect yesterday” na voz passiva.",
        "options": [
          "The suspect was arrested by the officers yesterday.",
          "The suspect is arrested by the officers yesterday.",
          "The officers were arrested by the suspect yesterday.",
          "The suspect arrested the officers yesterday."
        ],
        "answer": 0,
        "explanation": "O objeto passa a sujeito; was marca passado; arrested é particípio.",
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Will be + particípio forma passiva no futuro.",
      ...
      },
      {
        ...
        "options": [
          ...
          "não existe verbo na oração.",
          "a frase deve estar sempre no presente."
        ],
        "answer": 0,
        "explanation": "A passiva desloca o foco para quem recebe a ação ou para o acontecimento.",
        "tip": "Pense em notícias e relatórios."
      }
    ]
  },
  "11": {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Who introduz oração relativa e retoma pessoa: the officer.",
        "tip": "Procure o antecedente imediatamente compatível."
      },
      {
        "question": "Assinale a frase em que whose expressa corretamente posse.",
        "options": [
          "The man whose car was stolen called the police.",
          "The man which car was stolen called the police.",
          "The man who car was stolen called the police.",
          "The man where car was stolen called the police."
        ],
        "answer": 0,
        "explanation": "Whose estabelece relação de posse.",
        "tip": "Whose ≈ cujo/cuja."
      },
      {
        ...
        "answer": 0,
        "explanation": "Where retoma station como lugar.",
    ...
    "quiz": [
      {
        ...
        "answer": 0,
        "explanation": "Pistas do contexto.",
        "tip": "Revise a teoria escrita."
      },
      {
      ...
      },
      {
        ...
        "answer": 0,
        "explanation": "Ser sustentada pelo texto.",
        "tip": "Revise a teoria escrita."
      },
      {
        "question": "Um texto afirma que a medida “may reduce accidents”. A alternativa que diz “the measure will certainly eliminate accidents” é inadequada principalmente porque:",
        "options": [
          "transforma possibilidade em certeza absoluta.",
          "mantém exatamente o mesmo grau de certeza.",
          "apenas troca um substantivo.",
          "não altera o sentido."
        ],
        "answer": 0,
        "explanation": "May indica possibilidade; will certainly eleva indevidamente o grau de certeza.",
      ...
      },
      {
        ...
        "options": [
          ...
          "Traduzir palavra por palavra antes de ler a pergunta."
        ],
        "answer": 0,
        "explanation": "Pistas contextuais permitem inferência controlada.",
      ...
      },
      {
        ...
        "options": [
          ...
          "humorístico necessariamente.",
          "puramente narrativo sem avaliação."
        ],
        "answer": 0,
        "explanation": "Adjetivos avaliativos e urgência sinalizam preocupação/crítica.",
        "tip": "Tom é inferido por escolhas lexicais e modalização."
      }
    ]
  },
  "13": {
